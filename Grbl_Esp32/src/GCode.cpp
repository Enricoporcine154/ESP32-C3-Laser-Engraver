...
Error gc_execute_line(char* line, uint8_t client) {
    ...
    while (line[char_counter] != 0) {  // Loop until no more g-code words in line.
        ...
        // been repeated in the g-code block. If ok, update the command or record its value.
            ...
            // grbl_send(CLIENT_ALL, (const char*)String(letter).c_str());
            // grbl_send(CLIENT_ALL, " ");
            // grbl_send(CLIENT_ALL, (const char*)String(value).c_str());
            // grbl_send(CLIENT_ALL, "\r\n");
                ...
                case 'G':
                    ...
                    switch (int_value) {
                        ...
                        case 1:  // G1 - linear feedrate move
                            ...
                            mg_word_bit                 = ModalGroup::MG1;
                            axis_word_bit               = GCodeWord::Z;
                            gc_block.values.xyz[Z_AXIS] = SERVO_ONE_WAY_INTERVAL;
                            axis_words |= bit(Z_AXIS);
                            break;
                ...
                switch (letter) {
                    ...
                    case 'Z':
                        if (n_axis > Z_AXIS) {                            
                            ...
                            // grbl_send(CLIENT_ALL,"\r\n");
                            // }else{
                            //     gc_block.values.xyz[Z_AXIS] = SERVO_ONE_WAY_INTERVAL*-1;
                            //     axis_words |= bit(Z_AXIS);
                            //     grbl_send(CLIENT_ALL, "========Z0:");
                            //     grbl_send(CLIENT_ALL, "\r\n");
                            // }
                        } else {
                            FAIL(Error::GcodeUnsupportedCommand);
