...
#ifdef FORCE_SETTINGS_RESET
    // 强制重置所有设置为默认值
    grbl_msg_sendf(CLIENT_SERIAL, MsgLevel::Info, "FORCE_SETTINGS_RESET: Restoring all settings to defaults...");
    settings_restore(0xFF);  // 重置所有设置
#endif
...
#endif
#ifdef ESP32_C3
    // ESP32-C3 使用 BLE 代替经典蓝牙
    WebUI::ble_config.begin();
#endif
